...
function M.show_help()
  ...
  print "  :checkhealth joplin    - Run comprehensive system diagnostics"
  print "  :JoplinPing           - Quick connection test"
  print "  :JoplinHelp           - Show this help message"
  print ""
  print "🎯 Main Commands:"
  ...
  print "  • Run :checkhealth joplin for comprehensive diagnostics"
