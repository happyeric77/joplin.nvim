...
function M.setup(opts)
  ...
  if opts.api then
    ...
    if opts.api.token_env then
      opts.token_env = opts.api.token_env
    end
    if opts.api.token then
      opts.token = opts.api.token
    end
    if opts.api.port then
      opts.port = opts.api.port
    end
    if opts.api.host then
      opts.host = opts.api.host
    end
